...
CREATE TABLE `__new_games` (
	...
	`finished_at` numeric DEFAULT (CURRENT_TIMESTAMP),
...
INSERT INTO `__new_games`("id", "tournament_id", "player1_id", "player2_id", "winner_id", "player1_hits", "player2_hits", "player1_score", "player2_score", "created_at", "finished_at") SELECT "id", "tournament_id", "player1_id", "player2_id", "winner_id", "player1_hits", "player2_hits", "player1_score", "player2_score", "created_at", "finished_at" FROM `games`;--> statement-breakpoint
